...
public class Questao1 {
    public static void main1() {
        /*
        Sobrecarga de métodos. Java nos permite criar vários métodos com o mesmo nome desde que tenham parâmetros diferentes. Isso é o que chamamos de sobrecarga de métodos. A sobrecarga de métodos consiste em criarmos o mesmo método com possibilidades de entradas diferentes.
        */
        ...
        */
        ...
        /*
        Classes Abstratas e Métodos Abstratos. Classes abstratas tem uma função importante na orientação a objeto em Java. ... Ou seja, uma classe abstrata pode implementar ou não um método. Os métodos abstratos definidos em uma classe abstrata devem obrigatoriamente ser implementados em uma classe concreta
        */

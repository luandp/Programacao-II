 ...
 */
package listaexercicio.pkg03.arrayearraylist.entrega;

import listaexercicio.pkg03.arrayearraylist.entrega.Importados.AppAnuncio;

/**
 *
 * @author Luan Paulo
 */
public class ListaExercicio03ArrayEArrayListEntrega {
    ...
    public static void main(String[] args) {
        ...
        */
         ...
         /*
         Qual a diferença que um usuário da classe pode notar ao chamar o método adicionar
         notas com relação a versão que utiliza array? 
         
         R: o usuário não terá limite de notas e poderá adicionar notas apartir do .add
         */
